...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Exercise 1: Multimap<java.Seniority,List<Employees>> = " + seniorityMap(employees).toString());
        System.out.println("Exercise 2: Map<java.Seniority, Amount of employees for java.Seniority> = " + seniorityCounter(employees).toString());
        System.out.println("Exercise 3: Map<java.Seniority, Max Salary for java.Seniority> = " + seniorityMaxSalary(employees).toString());
